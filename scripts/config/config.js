  ...
  bsc: {
    ...
    assets: {
      ...
      iFIL: {
        ...
        heartbeat: ethers.utils.parseUnits("900", "wei"),
      },
      iBTC: {
  ...
  optimism: {
    ...
    assets: {
      iETH: {
        ...
        heartbeat: ethers.utils.parseUnits("1200", "wei"),
      },
      iUSDC: {
  ...
  polygon: {
    ...
    assets: {
      iMATIC: {
        ...
        heartbeat: ethers.utils.parseUnits("27", "wei"),
      },
      iUSDC: {
      ...
      iCRV: {
        ...
        heartbeat: ethers.utils.parseUnits("300", "wei"),
      },
      iUSDT: {
        address: "0xb3ab7148cCCAf66686AD6C1bE24D83e58E6a504e",
        priceModel: "ChainlinkHeartbeatModel",
